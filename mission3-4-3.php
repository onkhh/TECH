...
<body>
    ...
    ?>
        ...
        <input type="hidden" name="edit_name" placeholder="名前" value="<?php echo $edit_name; ?>">
        <input type="hidden" name="edit_comment" placeholder="コメント" value="<?php echo $edit_comment; ?>">
        <input type="hidden" name="update_submit" value="更新">
        </form>
