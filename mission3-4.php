...
<body>
    ...
    <!-- 編集フォーム -->
    <form action="" method="post">
        <input type="text" name="edit_post_number" value="echo $edit_post_number">
        <input type="text" name="edit_name" placeholder="名前" value="$edit_name">
        <input type="text" name="edit_comment" placeholder="コメント" value="$edit_comment">
