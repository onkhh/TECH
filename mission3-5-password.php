...
<body>
            ...
            //ファイルの存在がある場合は投稿番号+1、なかったら1を指定する
                ...
                //配列の数だけループさせる
                    ...
                    $data = explode("<>", $line);
                        ...
                        if ($data[0] == $editNO && $password3 == $edit_password) {
    ...
    <form action="" method="post">
        ...
        <input type="password" id="textPassword" class="password__input" name="password1" placeholder="パスワード">
        <span id="buttonEye" class="fa fa-eye" onclick="pushHideButton()"></span>
        <input type="submit" name="submit" value="投稿"><br>
        [削除フォーム]<br>
        <input type="number" name="delete_post_number" placeholder="削除対象番号">
        <input type="password" id="textPassword" class="password__input" name="password2" placeholder="パスワード">
        <span id="buttonEye" class="fa fa-eye" onclick="pushHideButton()"></span>
        <input type="submit" name="delete_submit" value="削除"><br>
        [編集フォーム]<br>
        <input type="number" name="edit_post_number" placeholder="編集対象番号">
        <input type="password" id="textPassword" class="password__input" name="password3" placeholder="パスワード">
        <span id="buttonEye" class="fa fa-eye" onclick="pushHideButton()"></span>
