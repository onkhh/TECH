...
<body>
    <?php
        ...
        // Create the table to store comments if it doesn't exist
        ...
        if (!empty($_POST["edit_post_number"]) && !empty($_POST["edit_password"])) {
            ...
            // Check if the edit post number exists and the password matches
        ...
        if (!empty($_POST["delete_post_number"]) && !empty($_POST["delete_password"])) {
            ...
            // Check if the comment exists and the password matches
