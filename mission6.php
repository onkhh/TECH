...
<body>
    ...
    <form action="" method="post">
      ...
      <input type="text" name="name" placeholder="企業" value="<?php if(isset($edit_name)) {echo $edit_name;}?>">
        <input type="text" name="comment" placeholder="やること" value="<?php if(isset($edit_comment)) {echo $edit_comment;} ?>">
...
<?php
// Output the list with conditional styling for memo
$filename = "mission6-2.txt";
$redText = []; // Store elements with red text
$blackText = []; // Store elements with black text
